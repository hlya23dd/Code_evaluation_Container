...
n_segment_per_run=500
	...
	do
           ...
           mkdir ./feature_generation/feature_generation_Patient"$patient_index"_part"$i"
           cp fea_gen.py AR_v160_svm.py ./feature_generation/feature_generation_Patient"$patient_index"_part"$i"
